...
<div class="form-group{{ $errors->has('penerangan_program') ? ' has-error' : '' }}">
    ...
    <div class="col-md-8">
        ...
        <div class="col-md-8">
            <input id="tarikh_mula" type="date" class="form-control" name="tarikh_mula" value="{{ $pendaftaran->tarikh_mula }}" readonly>
    ...
    <div class="col-md-8">
        <input id="tarikh_akhir" type="date" class="form-control" name="tarikh_akhir" value="{{ $pendaftaran->tarikh_akhir }}" readonly>
...
<div class="form-group{{ $errors->has('masa_mula') ? ' has-error' : '' }}">
    ...
    <div class="col-md-8">
        <input id="masa_mula" type="time" class="form-control" name="masa_mula" value="{{ $pendaftaran->masa_mula }}" readonly>
...
<div class="col-md-8">
    <input id="masa_akhir" type="time" class="form-control" name="masa_akhir" value="{{ $pendaftaran->masa_akhir }}" readonly>
